...
import { Banknote, Briefcase, Building2, Calendar, Clock, Heart, MapPin, X,ChevronRight, Monitor, Earth } from 'lucide-react';
  ...
  return (
    <div className="flex w-full flex-col items-center mt-10 mb-52 px-4 md:px-8">
      ...
      <div className="flex flex-col p-5 items-start bg-white w-full md:w-10/12 lg:w-8/12 shadow-lg rounded-lg">
        {/* Job Title */}
        <div className="mb-4">
          <h5 className="font-bold mb-2 text-neutral-dark">Journeyman Plumber</h5>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          <div className="flex items-center">
            ...
            <p className="text-base text-gray-600 ml-2">G&C Plumbing & Heating LLC</p>
          </div>
          <div className="flex items-center">
            <span className="text-green-700">
              <MapPin size={18} />
            </span>
            <p className="text-base text-gray-600 ml-2">Bellingham, MA, US</p>
          </div>
          <div className="flex items-center">
            <span className="text-orange-500">
              <Banknote size={18} />
            </span>
            <p className="text-base text-gray-600 ml-2">$72,800 - $115,000</p>
          </div>
          <div className="flex items-center ">
            <span className='flex text-primary'><Earth size={18} /></span>
            <p className="text-base ml-2 text-gray-600">Remote, Hybrid, On-Location</p>
          </div>
        </div>
        ...
        {/* About Section */}
        <p className="text-lg font-semibold text-neutral-dark mb-2">About G&C Plumbing & Heating LLC</p>
        ...
        {/* Position Overview */}
        <p className="text-lg font-semibold text-neutral-dark mb-2">Position Overview</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-5 gap-4 w-full">
          <div className="flex flex-col w-full">
            <span className="items-center flex flex-row ">
             <span className='text-blue-500 '><Briefcase size={18} /></span> 
              <p className="text-base ml-2">Experience Required</p>
            </span>


            <p className="text-base ml-7">NaN</p>
          ...
          <div className="flex flex-col">
            ...
            <span className='text-[#038134] '><Clock size={18} /> </span>
              <p className="text-base ml-2">Work Schedule</p>
            </span>


            <p className="text-base ml-7">Flexible 8-hour shifts, day shift, rotating weekends, year-round work</p>
        ...
        <div className="mt-6">
          <p className="text-lg text-neutral-dark font-semibold mb-2">Key Responsibilities</p>
        ...
        {/* Requirements */}
        <div className="mt-6">
          <p className="text-lg text-neutral-dark font-semibold mb-2">Requirements</p>
          <ul className="list-disc ml-5 space-y-3">
        ...
        {/* Soft Skills */}
        <div className="mt-6">
          <p className="text-lg text-neutral-dark font-semibold mb-2">Soft Skills</p>
          <div className="flex p-0 gap-2">
            <div className="bg-accent-light justify-center items-center px-3 rounded-full">
              <p className="text-accent-secondary p-1 text-sm font-medium text-center">Customer-focused attitude</p>
            </div>
            <div className="bg-accent-light justify-center items-center px-3 rounded-full">
            <p className="text-accent-secondary p-1 text-sm font-medium text-center">Commitment to quality work</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6">
          <p className="text-lg text-neutral-dark font-semibold mb-2">Required Technologies</p>
          <div className="flex p-0 gap-2">
            <div className="bg-accent-light justify-center items-center px-3 rounded-full">
              <p className="text-accent-secondary p-1 text-sm font-medium text-center">Customer-focused attitude</p>
            </div>
